...
export class ProductsController {
  ...
  createProduct(@Body() createProductDto: CreateProductDto) {
    return this.productsClients.send( {cmd: 'create_product'}, createProductDto);
    //return 'Crea un producto';
  }

  @Get()
  findAllProducts(@Query() paginationDto:PaginationDto) {
    return this.productsClients.send({ cmd: 'find_all_products' }, paginationDto);
  ...
  async findOne(@Param('id') id: string ) {
    ...
    return this.productsClients.send({ cmd: 'find_one_product'}, { id })
    .pipe(
  ...
  patchProduct(
    ...
    return this.productsClients.send({ cmd: 'update_product' }, 
      {
        id,
        ...updateProductDto
      }          
